...
const goukaNbaaDirectionStyle = document.createElement("style");
goukaNbaaDirectionStyle.textContent = `
/* GOUKA NBAA direction polish: quieter business UI, clearer daily workflow */
.app { background:#dfe6e1 !important; }
aside {
  background:#fff !important;
  border-right:1px solid #cdd8d0 !important;
  box-shadow:none !important;
}
aside .brand {
  color:#0f172a !important;
  border-bottom:3px solid #18a63d !important;
  margin-bottom:12px !important;
}
aside .brand small { color:#10852f !important; letter-spacing:.08em; font-weight:900; }
aside button {
  border-radius:0 !important;
  background:#fff !important;
  color:#0f172a !important;
  border:0 !important;
  border-bottom:2px solid #18a63d !important;
...
aside button.active {
  background:#19a83d !important;
  color:#fff !important;
  border-bottom-color:#19a83d !important;
}
aside .logout-btn {
...
main > header {
  background:#fff !important;
  border-top:5px solid #18a63d !important;
  border-radius:0 !important;
  box-shadow:none !important;
  margin-bottom:14px !important;
}
main > header h1 { font-size:28px !important; color:#0b2341 !important; }
main > header p { color:#0f172a !important; font-weight:800 !important; }
.panel {
  border-radius:0 !important;
...
.toolbar {
  border-bottom:3px solid #19a83d !important;
...
button.primary, .primary, button.active {
  background:#18a63d !important;
  border-color:#18a63d !important;
  color:#fff !important;
}
.ghost {
  background:#fff !important;
  border-color:#b8c8d7 !important;
}
.v3-dashboard { display:block; }
.v3-hero {
  background:#fff !important;
  border-top:5px solid #18a63d !important;
  border-radius:0 !important;
...
.v3-hero h1 { color:#0b2341 !important; }
.v3-hero p { color:#334155 !important; }
.v3-kicker {
  color:#18a63d !important;
  background:#e9f8ec !important;
  border:1px solid #b7d7bd !important;
}
.v3-hero-right {
  border-radius:0 !important;
  border:1px solid #b7d7bd !important;
...
.gouka-nbaa-flow-head h2 {
  margin:0;
  color:#0b2341;
  font-size:22px;
}
.gouka-nbaa-flow-head p {
  margin:4px 0 0;
  color:#64748b;
  font-size:13px;
}
.gouka-nbaa-flow-grid {
  display:grid;
  grid-template-columns:repeat(6,minmax(0,1fr));
  gap:8px;
}
.gouka-nbaa-flow-step {
...
.gouka-nbaa-flow-step strong {
  display:block;
  color:#0b2341;
  font-size:15px;
  margin-bottom:5px;
}
.gouka-nbaa-flow-step span {
  display:block;
  color:#64748b;
  font-size:12px;
  line-height:1.45;
}
.gouka-nbaa-flow-step b {
  display:inline-flex;
  align-items:center;
...
.v3-kpi, .v3-money-card, .v3-panel, .gouka-alert-card, .gouka-workbench-btn, .inventory-summary-card {
  ...
  box-shadow:none !important;
  border:1px solid #d4ded7 !important;
  border-top:4px solid #18a63d !important;
}
.v3-kpi:hover, .v3-money-card:hover, .v3-panel:hover, .gouka-alert-card:hover, .gouka-workbench-btn:hover {
  transform:none !important;
  box-shadow:none !important;
}
.inventory-summary-grid { gap:8px !important; }
.inventory-summary-card small { color:#334155 !important; font-weight:800 !important; }
.inventory-summary-card b { color:#061a33 !important; }
.ledger-card,
.auction-card {
  border-radius:0 !important;
...
const goukaBackOfficeSkinStyle = document.createElement("style");
goukaBackOfficeSkinStyle.textContent = "\n:root{--bo-green:#18a83e;--bo-green-dark:#10852f;--bo-blue:#0d9fda;--bo-ink:#1f2933;--bo-muted:#68737d;--bo-line:#d9dfdc;--bo-bg:#dfe3e0;--bo-soft:#f6f8f7;}\nbody{background:var(--bo-bg)!important;color:var(--bo-ink)!important;font-family:\"Inter\",\"Yu Gothic\",\"Meiryo\",\"Microsoft YaHei\",Arial,sans-serif!important;}\n.app{background:var(--bo-bg)!important;min-height:100vh!important;display:grid!important;grid-template-columns:220px minmax(0,1fr)!important;gap:0!important;}\naside{background:#fff!important;border-right:1px solid #ccd5d0!important;padding:16px 14px!important;color:var(--bo-ink)!important;box-shadow:none!important;}\naside .brand{border-bottom:3px solid var(--bo-green)!important;padding:0 0 14px!important;margin-bottom:12px!important;color:var(--bo-ink)!important;}\naside .brand b{font-size:17px!important;color:var(--bo-ink)!important;letter-spacing:.02em!important;}\naside .brand span{color:var(--bo-green-dark)!important;font-size:12px!important;font-weight:800!important;letter-spacing:.08em!important;}\naside button{width:100%!important;border:0!important;border-bottom:2px solid var(--bo-green)!important;border-radius:0!important;background:#fff!important;color:var(--bo-ink)!important;text-align:left!important;padding:12px 10px!important;font-weight:900!important;letter-spacing:.02em!important;box-shadow:none!important;}\naside button:hover{background:#f2fbf5!important;color:var(--bo-green-dark)!important;}\naside button.active{background:var(--bo-green)!important;color:#fff!important;border-bottom-color:var(--bo-green)!important;}\naside .logout-btn{margin-top:16px!important;background:#f8fafc!important;color:#475569!important;border:1px solid #dbe3ef!important;text-align:center!important;border-radius:4px!important;}\nmain{background:var(--bo-bg)!important;padding:24px 28px 42px!important;max-width:1500px!important;margin:0 auto!important;width:100%!important;}\nmain>header{background:#fff!important;border:1px solid var(--bo-line)!important;border-top:5px solid var(--bo-green)!important;border-radius:0!important;padding:18px 22px!important;margin-bottom:18px!important;box-shadow:none!important;align-items:center!important;}\nmain>header h1{font-size:27px!important;line-height:1.25!important;color:var(--bo-ink)!important;margin:0 0 4px!important;font-weight:950!important;}\nmain>header p{font-size:14px!important;color:#334155!important;margin:0!important;font-weight:700!important;}\n.action-row{gap:8px!important;}\n.panel,.card,.v3-panel,.sales-center,.restricted-panel{background:#fff!important;border:1px solid var(--bo-line)!important;border-radius:0!important;box-shadow:none!important;}\n.panel{padding:18px!important;}.panel.wide{max-width:none!important;}\n.toolbar{background:#fff!important;border-bottom:3px solid var(--bo-green)!important;padding:0 0 12px!important;margin-bottom:14px!important;align-items:center!important;}\n.toolbar h2,.panel h2{font-size:24px!important;color:var(--bo-ink)!important;font-weight:950!important;margin:0!important;letter-spacing:.02em!important;}\n.toolbar-right{gap:8px!important;}.search{border:1px solid #cfd8d3!important;background:#fff!important;border-radius:3px!important;min-height:36px!important;}\ninput,select,textarea{border:1px solid #cfd8d3!important;border-radius:3px!important;background:#fff!important;color:var(--bo-ink)!important;min-height:34px!important;box-shadow:none!important;}\ninput:focus,select:focus,textarea:focus{outline:2px solid rgba(24,168,62,.18)!important;border-color:var(--bo-green)!important;}\nbutton{border-radius:4px!important;border:1px solid #cfd8d3!important;background:#fff!important;color:var(--bo-ink)!important;font-weight:900!important;min-height:34px!important;box-shadow:none!important;}\nbutton:hover{border-color:var(--bo-green)!important;color:var(--bo-green-dark)!important;background:#f2fbf5!important;}\nbutton.primary,.primary,button.active{background:var(--bo-green)!important;border-color:var(--bo-green)!important;color:#fff!important;}\nbutton.ghost,.ghost{background:#fff!important;border-color:#cbd5e1!important;color:#243243!important;}button.danger,.danger{background:#fff5f5!important;border-color:#fecaca!important;color:#b91c1c!important;}\n.pill,.status,.inventory-pending{border-radius:999px!important;border:1px solid #cbd5e1!important;background:#f8fafc!important;color:#334155!important;font-weight:900!important;}\n.tablewrap{border:1px solid var(--bo-line)!important;border-radius:0!important;background:#fff!important;box-shadow:none!important;}\ntable{border-collapse:collapse!important;background:#fff!important;font-size:13px!important;}\nth{background:var(--bo-green)!important;color:#fff!important;border:1px solid #fff!important;padding:10px 9px!important;font-weight:950!important;white-space:nowrap!important;text-align:center!important;}\ntd{border:1px solid #dfe5e2!important;padding:9px 8px!important;vertical-align:middle!important;color:#233044!important;background:#fff!important;}\ntbody tr:nth-child(even) td{background:#fbfcfb!important;}tbody tr:hover td{background:#f1fbf4!important;}\n.thumb,.product-record-main-image,.product-record-thumbs img{border-radius:3px!important;border:1px solid #cfd8d3!important;}\n.table-actions{gap:6px!important;flex-wrap:nowrap!important;}.table-actions button{min-height:30px!important;padding:5px 9px!important;white-space:nowrap!important;}\n.inventory-summary-grid{gap:10px!important;}.inventory-summary-card{border-radius:0!important;border:1px solid var(--bo-line)!important;border-top:4px solid var(--bo-green)!important;background:#fff!important;min-height:72px!important;padding:10px 12px!important;}\n.inventory-summary-card small{color:#44515f!important;font-size:12px!important;}.inventory-summary-card b{font-size:20px!important;color:#111827!important;}.inventory-summary-card.warn{background:#fffdf7!important;border-top-color:#f59e0b!important;}.inventory-summary-card.good{background:#f6fff9!important;border-top-color:var(--bo-green)!important;}\n.inventory-group-toolbar{background:#fff!important;border:1px solid var(--bo-line)!important;padding:10px!important;margin-bottom:12px!important;}.inventory-group-toolbar button{border-radius:3px!important;}.inventory-group-toolbar button.active{background:var(--bo-green)!important;color:#fff!important;border-color:var(--bo-green)!important;}\n.inventory-group-badge{border-radius:3px!important;border:1px solid var(--bo-green)!important;background:#f2fbf5!important;color:var(--bo-green-dark)!important;font-weight:950!important;}\n.filter-row{background:#f7faf8!important;border:1px solid var(--bo-line)!important;padding:10px!important;border-radius:0!important;}.note{color:#52606d!important;line-height:1.7!important;}\n.v3-dashboard{gap:14px!important;}.v3-hero{border-radius:0!important;background:#fff!important;border:1px solid var(--bo-line)!important;border-top:5px solid var(--bo-green)!important;color:var(--bo-ink)!important;box-shadow:none!important;}.v3-hero h1{color:var(--bo-ink)!important;font-size:28px!important;}.v3-hero p{color:#334155!important;}.v3-kicker{background:var(--bo-green)!important;color:#fff!important;border-radius:3px!important;}\n.v3-money-card,.metric-card,.record-card,.product-record-page,.product-record-identity,.product-record-photo{border-radius:0!important;border:1px solid var(--bo-line)!important;box-shadow:none!important;background:#fff!important;}\n.form-grid{gap:10px!important;}.form-grid label,.record-field{border-radius:0!important;}label small,.record-field small{color:#475569!important;font-weight:900!important;}.image-modal .panel{border-top:5px solid var(--bo-green)!important;}\n@media(max-width:900px){.app{grid-template-columns:1fr!important}aside{position:relative!important}main{padding:14px!important}main>header{display:block!important}.toolbar{display:block!important}.toolbar-right{margin-top:10px!important}.tablewrap{overflow:auto!important}}\n";
document.head.appendChild(goukaBackOfficeSkinStyle);

const goukaStableWidePatchStyle = document.createElement("style");
goukaStableWidePatchStyle.textContent = "\n/* GOUKA stable wide patch: current version based, safe layout only */\n.app{grid-template-columns:220px minmax(0,1fr)!important;}\nmain{max-width:none!important;width:100%!important;margin:0!important;padding:18px 22px 42px!important;}\nmain>header{max-width:none!important;width:100%!important;box-sizing:border-box!important;}\n.panel,.card,.v3-panel,.sales-center,.restricted-panel{max-width:none!important;box-sizing:border-box!important;}\n.tablewrap{width:100%!important;max-width:100%!important;overflow-x:auto!important;overflow-y:visible!important;}\n.tablewrap table{width:100%!important;min-width:1180px!important;table-layout:auto!important;}\nth,td{font-size:12px!important;line-height:1.45!important;}\nth{padding:9px 7px!important;}\ntd{padding:8px 7px!important;}\n.product-name-clamp{max-width:460px!important;}\n.table-actions{display:flex!important;gap:5px!important;flex-wrap:nowrap!important;white-space:nowrap!important;}\n.table-actions button{padding:5px 8px!important;font-size:12px!important;}\n.inventory-summary-grid{grid-template-columns:repeat(4,minmax(0,1fr))!important;}\n.toolbar{gap:12px!important;}\n.toolbar-right{display:flex!important;justify-content:flex-end!important;gap:8px!important;flex-wrap:wrap!important;}\n.search{min-width:260px!important;}\n@media(max-width:1200px){\n  main{padding:14px!important;}\n  .inventory-summary-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important;}\n  .tablewrap table{min-width:1080px!important;}\n}\n@media(max-width:760px){\n  .app{grid-template-columns:1fr!important;}\n  aside{position:relative!important;width:100%!important;}\n  .inventory-summary-grid{grid-template-columns:1fr!important;}\n  .toolbar-right{justify-content:flex-start!important;}\n}\n";
document.head.appendChild(goukaStableWidePatchStyle);
...
/* GOUKA ledger card view: clean legal record + fast daily reading */
.ledger-card-list{display:flex;flex-direction:column;gap:14px;margin-top:14px;}
.ledger-card{background:#fff;border:1px solid #d6ded9;border-top:5px solid #18a63d;border-radius:0;box-shadow:none;display:grid;grid-template-columns:minmax(0,1fr) 156px;gap:0;overflow:hidden;}
.ledger-card-main{padding:0;}
.ledger-card-overview{display:grid;grid-template-columns:minmax(0,1fr) 330px;gap:12px;padding:12px 14px;background:#fbfdfb;border-bottom:1px solid #dfe5e2;}
.ledger-card-title-row{display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin-bottom:8px;}
.ledger-card-no{font-size:12px;font-weight:950;color:#10852f;border:1px solid #b7e4c5;background:#effaf2;padding:3px 8px;}
.ledger-card-title{font-size:17px;font-weight:950;color:#0b2341;line-height:1.35;margin:0 0 6px;word-break:break-word;}
.ledger-card-subtitle{font-size:13px;font-weight:850;color:#52606d;line-height:1.45;margin:0;}
.ledger-card-tags{display:flex;flex-wrap:wrap;gap:6px;margin-top:9px;}
.ledger-card-tag{display:inline-flex;align-items:center;border:1px solid #d5dbe5;background:#fff;color:#102033;padding:3px 8px;font-size:12px;font-weight:900;}
.ledger-card-money{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;align-content:start;}
.ledger-money-cell{border:1px solid #dfe5e2;background:#fff;padding:8px 9px;min-height:54px;}
.ledger-money-cell span{display:block;font-size:12px;color:#64748b;font-weight:900;margin-bottom:5px;}
.ledger-money-cell b{display:block;font-size:15px;color:#0b2341;font-weight:950;line-height:1.25;word-break:break-word;}
.ledger-card-detail-toggle{margin-top:10px!important;min-height:32px!important;padding:6px 12px!important;}
.ledger-card-grid{display:grid;grid-template-columns:128px minmax(0,1fr) 128px minmax(0,1fr);border-left:1px solid #dfe5e2;}
.ledger-card-label{background:#f2fbf5;color:#10852f;font-weight:950;text-align:left;padding:10px 11px;border-right:1px solid #dfe5e2;border-bottom:1px solid #dfe5e2;line-height:1.35;}
.ledger-card-value{background:#fff;color:#102033;font-weight:750;padding:10px 12px;border-right:1px solid #dfe5e2;border-bottom:1px solid #dfe5e2;line-height:1.45;word-break:break-word;}
.ledger-card-value.strong{font-size:15px;font-weight:950;}
.ledger-card-value.full{grid-column:span 3;}
.ledger-card-section{grid-column:1/-1;background:#eef7f1;color:#10852f;font-weight:950;padding:9px 12px;border-right:1px solid #dfe5e2;border-bottom:1px solid #dfe5e2;letter-spacing:.03em;}
...
.ledger-card-image .thumb{width:132px!important;height:132px!important;object-fit:cover!important;border:1px solid #d5dbe5!important;background:#fff!important;}
.ledger-card-actions{display:grid;grid-template-columns:1fr;gap:7px;width:100%;}
.ledger-card-actions button{font-size:13px!important;padding:7px 8px!important;min-height:33px!important;}
.ledger-card-status{display:inline-flex;align-items:center;border:1px solid #bbf7d0;background:#ecfdf5;border-radius:999px;padding:3px 10px;font-size:12px;font-weight:950;color:#047857;}
.ledger-card-status.warn{border-color:#fed7aa;background:#fff7ed;color:#c2410c;}
...
@media(max-width:1100px){.ledger-card-overview{grid-template-columns:1fr}.ledger-card-grid{grid-template-columns:120px minmax(0,1fr)}.ledger-card-value.full{grid-column:auto}.ledger-card-label:nth-last-child(2)+.ledger-card-value{grid-column:auto}}
@media(max-width:900px){.ledger-card{grid-template-columns:1fr}.ledger-card-image{border-left:0;border-top:1px solid #dfe5e2}.ledger-card-grid{grid-template-columns:112px minmax(0,1fr)}.ledger-card-label,.ledger-card-value{font-size:13px!important;padding:9px 8px!important}.ledger-card-money{grid-template-columns:1fr}.ledger-card-title{font-size:16px}}
`;
...
const goukaAuctionWorkbenchPatchStyle = document.createElement("style");
goukaAuctionWorkbenchPatchStyle.textContent = "\n/* GOUKA auction workbench quick controls */\n.auction-quickbar{display:flex;flex-wrap:wrap;gap:8px;align-items:center;margin:12px 0 6px;padding:10px;border:1px solid #d6ded9;background:#fbfcfb;}\n.auction-quickbar button{min-height:32px!important;padding:6px 12px!important;font-size:13px!important;}\n.auction-quickbar button.active{background:#18a83e!important;border-color:#18a83e!important;color:#fff!important;}\n.auction-quickbar .hint{font-size:12px;font-weight:850;color:#52606d;margin-left:auto;}\n.auction-quality-badge{display:inline-flex;align-items:center;margin-left:8px;padding:2px 8px;border-radius:999px;font-size:12px;font-weight:950;border:1px solid #bbf7d0;background:#ecfdf5;color:#047857;}\n.auction-quality-badge.warn{border-color:#fed7aa;background:#fff7ed;color:#c2410c;}\n.auction-card-section{display:flex;align-items:center;gap:6px;flex-wrap:wrap;}\n@media(max-width:900px){.auction-quickbar .hint{width:100%;margin-left:0}.auction-quickbar button{flex:1 1 auto;}}\n";
document.head.appendChild(goukaAuctionWorkbenchPatchStyle);

const goukaProductRecordPolishStyle = document.createElement("style");
...
function normalizeImportBatch(batch = {}) {
  ...
  return {
    ...batch,
    id: batch.id || batch.importBatchId || batch.customsBatchId || "",
    importBatchId: batch.importBatchId || batch.id || "",
    emsNo: batch.emsNo || batch.emsTrackingNo || batch.ems || "",
    ...
    totalImportConsumptionTaxJpy: importConsumptionTaxJpy + localConsumptionTaxJpy,
    agencyFeeJpy,
    customsFeeJpy: agencyFeeJpy,
    internationalShippingJpy,
    shippingJpy: internationalShippingJpy,
    otherCostJpy: Number(batch.otherCostJpy || 0),
    attachments: Array.isArray(batch.attachments) ? batch.attachments : String(batch.attachmentsText || batch.attachmentMemo || "").split(/\n|,/).map((x) => x.trim()).filter(Boolean)
  };
}
...
function App() {
  ...
  const [session, setSession] = useState(() => {
    try {
      ...
      if (raw === "yes") return { username: "gouka", role: "owner", name: "管理者账号" };
  ...
  const totals = useMemo(() => {
    const batchIdsWithActualTax = new Set((customsBatches || []).map(normalizeImportBatch).filter((b) => Number(b.totalImportConsumptionTaxJpy || 0) > 0).map((b) => b.id));
    ...
    base.inputTax += (customsBatches || []).reduce((a, b) => a + Number(normalizeImportBatch(b).totalImportConsumptionTaxJpy || 0), 0);
  ...
  async function deleteItem(id) {
    ...
    if (!target) return;
    const reason = window.prompt("请输入删除原因：\n\n" + target.id + " " + (target.brand || "") + " " + (target.item || ""), "误录入 / 重复录入 / 管理者确认删除");
  ...
  function companyPdfHeader(title, subtitle = "Inventory Report") {
    ...
    return `
      <div class="company-letterhead enterprise-letterhead">
        <div class="company-left">
          ...
          <div class="identity-block">
            ...
            <div>古物商許可番号：第62203R074231号</div>
            <div>許可公安委員会：大阪府公安委員会</div>
            <div>TEL：06-7176-7189</div>
          </div>
        </div>
        <div class="company-right doc-block">
          <div class="license-badge">古物商許可業者<br/>大阪府公安委員会許可<br/>第62203R074231号</div>
          ...
          <div class="doc-value">${htmlEscape(printedAt)} JST</div>
        </div>
      </div>
      <div class="report-title enterprise-title">
        ...
        <div class="erp-version">GOUKA ERP</div>
      </div>
    `;
  }
...
<style>
  * { box-sizing: border-box; }
  ...
  .company-en { font-size:11px; letter-spacing:.08em; color:#475569; margin-top:1px; font-weight:700; }
  .identity-block { margin-top:7px; font-size:12px; line-height:1.65; color:#111827; }
  .license-badge { display:inline-block; border:1px solid #111827; border-radius:8px; padding:8px 10px; margin-bottom:14px; font-size:11px; line-height:1.45; color:#111827; text-align:left; background:#fff; }
...
<div class="pdf-page">${bodyHtml}</div>
  ...
  function exportInventoryPdf(targetItems = null, label = "库存报告") {
    ...
    const sum = arr.reduce((a, x) => {
      ...
      const paidTotal = auction ? Number(auction.invoiceTotal || 0) : Number(t.costJpy || 0);
      a.paid += paidTotal;
      a.cost += Number(t.costJpy || 0);
      a.inputTax += auction ? Number(auction.taxCredit || 0) : Number(t.inputTax || 0);
      a.sale += saleJpy;
      a.profit += saleJpy > 0 ? Number(t.profitExTax || 0) : 0;
      a.qty += Number(x.qty || 1);
      return a;
    }, { qty: 0, paid: 0, cost: 0, inputTax: 0, sale: 0, profit: 0 });
    ...
    const rows = arr.map((x) => {
      ...
      const saleJpy = Number(t.saleJpy || 0);
      const paidTotal = auction ? Number(auction.invoiceTotal || 0) : Number(t.costJpy || 0);
      const inputTax = auction ? Number(auction.taxCredit || 0) : Number(t.inputTax || 0);
      const saleLabel = saleJpy > 0 ? jpy(saleJpy) : '<span class="muted">未定</span>';
      const profitLabel = saleJpy > 0 ? jpy(t.profitExTax) : '<span class="muted">未定</span>';
      return `<tr>
        ...
        <td>${htmlEscape(auction?.platform || x.source || "")}</td>
        <td class="right">${jpy(paidTotal)}</td>
        <td class="right">${jpy(t.costJpy)}</td>
        <td class="right">${jpy(inputTax)}</td>
        <td class="right">${saleLabel}</td>
        <td class="right">${profitLabel}</td>
      </tr>`;
    }).join("");
    ...
    const body = `
      ...
      <div class="section"><h2>汇总</h2><div class="summary-grid">
        ...
        <div class="field"><small>实际支付合计</small><b>${jpy(sum.paid)}</b></div>
        <div class="field"><small>库存总成本</small><b>${jpy(sum.cost)}</b></div>
        <div class="field"><small>可抵扣消费税参考</small><b>${jpy(sum.inputTax)}</b></div>
        <div class="field"><small>预计/实际销售额</small><b>${jpy(sum.sale)}</b></div>
        <div class="field"><small>预计/实际利润</small><b>${jpy(sum.profit)}</b></div>
      </div></div>
      <div class="section"><h2>库存明细</h2><table><thead><tr><th>图</th><th>商品编号</th><th>入库日</th><th>品牌</th><th>商品</th><th>状态</th><th>来源</th><th>实际支付合计</th><th>库存成本</th><th>可抵扣消费税</th><th>预计/实际售价</th><th>预计/实际利润</th></tr></thead><tbody>${rows}</tbody></table></div>
      <div class="footer">GOUKA ERP / Generated by GOUKA ERP. 日本拍卖商品按「实际支付合计、库存成本、可抵扣消费税」分开表示。金额与消费税为经营参考，正式申告请交由税理士确认。</div>
    `;
    openPdfWindow(`${label}_${localDateString()}`, body);
  }
  ...
  function exportAuctionPdf(targetItems = null) {
    ...
    const body = `
      ...
      <div class="section"><h2>日本拍卖明细</h2><table><thead><tr><th>图</th><th>商品编号</th><th>品牌</th><th>商品</th><th>拍卖会</th><th>落札コード</th><th>Lot</th><th>箱番</th><th>枝番</th><th>拍卖日</th><th>付款总额</th><th>库存成本</th><th>消费税控除</th></tr></thead><tbody>${rows}</tbody></table></div>
  ...
  function exportTaxPdf() {
    ...
    const importConsumptionTax = (customsBatches || []).reduce((sum, b) => sum + Number(normalizeImportBatch(b).totalImportConsumptionTaxJpy || 0), 0);
    ...
    const importRows = (customsBatches || []).map((rawBatch) => { const b = normalizeImportBatch(rawBatch); return `<tr><td>${htmlEscape(b.id)}</td><td>${htmlEscape(b.importDate || "")}</td><td class="right">${jpy(b.totalImportConsumptionTaxJpy)}</td><td>${htmlEscape(b.memo || "")}</td></tr>`; }).join("");
...
function Dashboard({ totals, items, setTab, openInventorySignal = null, exportBackup, customsBatches = [], onCashflowSave = () => {} }) {
  ...
  const normalizedImportBatches = (customsBatches || []).map(normalizeImportBatch);
  const cumulativeImportValue = normalizedImportBatches.reduce((a, b) => a + Number(b.goodsValueJpy || b.declaredTotalJpy || 0), 0);
  const cumulativeDuty = normalizedImportBatches.reduce((a, b) => a + Number(b.dutyJpy || 0), 0);
    ...
    <section className="v3-dashboard">
      ...
      <div className="v3-hero">
        <div>
          ...
          <p>中古奢侈品业务数据汇总。集中查看库存成本、预计利润、销售、报关与待处理事项。</p>
      ...
      <div className="gouka-nbaa-flow">
        <div className="gouka-nbaa-flow-head">
          <div>
            <h2>日常业务流程</h2>
            <p>按照拍卖后台的工作方式，把每天要走的步骤放在一排，哪里有待处理一眼看见。</p>
          </div>
          <span className="pill">NBAA Style Workflow</span>
        </div>
      ...
      <div className="v3-money-grid">
        ...
        <div className="v3-money-card highlight"><p>库存预警</p><h2>{longTerm} 件</h2><small>365日以上库存</small></div>
      </div>

      <div className="v3-money-grid">
        <div className="v3-money-card"><p>累计进口额</p><h2>{jpy(cumulativeImportValue)}</h2><small>Import Batch 货值</small></div>
        <div className="v3-money-card"><p>累计关税</p><h2>{jpy(cumulativeDuty)}</h2><small>按批次汇总</small></div>
        <div className="v3-money-card"><p>累计进口消费税</p><h2>{jpy(cumulativeImportTax)}</h2><small>不进入库存成本</small></div>
        <div className="v3-money-card highlight"><p>库存资金占用</p><h2>{jpy(inventoryCapital)}</h2><small>未售库存成本</small></div>
      </div>
    ...
    <div className="product-record-page">
      ...
      <div className="product-record-grid">
        ...
        <RecordCard title="资金流水" summary="采购 → 进口 → 销售 → 到账 → 利润" defaultOpen>
          ...
          <RecordField label="报关编号" value={importBatch.customsDeclarationNo || item.customsDeclarationNo || ""} />
          <RecordField label="分摊关税" value={jpy(Number(item.batchAllocatedDutyJpy || item.dutyJpy || 0))} />
          <RecordField label="分摊代理费" value={jpy(Number(item.batchAllocatedCustomsFeeJpy || item.customsFeeJpy || 0))} />
          <RecordField label="分摊国际运费" value={jpy(Number(item.batchAllocatedShippingJpy || item.shippingJpy || 0))} />
          <RecordField label="进口消费税参考" value={jpy(importConsumptionTax)} />
          <RecordField label="销售含税" value={saleJpy ? jpy(saleJpy) : ""} />
          <RecordField label="销售未税收入" value={saleJpy ? jpy(sales.salesRevenueExTax) : ""} />
          <RecordField label="平台手续费" value={jpy(Number(sales.platformFeeTaxIncluded || 0))} />
          <RecordField label="最终到账" value={finalReceipt ? jpy(finalReceipt) : ""} />
          <RecordField label="实际利润" value={saleJpy ? jpy(actualProfit) : ""} />
          <RecordField label="利润率" value={saleJpy ? `${Number(sales.margin || 0).toFixed(1)}%` : ""} />
        </RecordCard>
...
function Inventory({ items, query, setQuery, statusFilter, setStatusFilter, downloadCSV, editItem, deleteItem, isOwner, canEdit = true, canExportPdf = true, canViewFinance = true, setPreviewImage, setPreviewScale, exportItemPdf, quickSignal }) {
  ...
  const headers = ["来源分组", "图片", "商品编号", "入库日", "库龄", "品牌", "商品名", "来源", "资料", "状态", "库位", "平台", "库存成本", "售价/成交价（含税）", "预计/实际利润", "操作"];
...
function Ledger({ items, setItems, isOwner, downloadCSV, exportItemPdf }) {
  ...
  function toggleLedgerDetail(id) {
    setOpenLedgerIds((prev) => prev.includes(id) ? prev.filter((x) => x !== id) : [...prev, id]);
  }
    ...
    <div className="panel">
      ...
      <div className="ledger-card-list">
        {(Array.isArray(ledgerPageItems) ? ledgerPageItems : []).map((x, i) => {
          ...
          const inventoryCost = auction ? jpy(auction.inventoryCost) : jpy(tax.costJpy);
          const taxCredit = auction ? jpy(auction.taxCredit) : jpy(tax.inputTax);
          const ledgerStatus = ledgerStatusLabel(x);
          const statusClass = ledgerStatus === "有效" ? "ledger-card-status" : "ledger-card-status warn";
          const isDetailOpen = openLedgerIds.includes(x.id);
          return (
            <div className="ledger-card" key={x.id || i}>
              <div className="ledger-card-main">
                <div className="ledger-card-overview">
                  <div>
                    <div className="ledger-card-title-row">
                      <span className="ledger-card-no">No.{ledgerStart + i + 1}</span>
                      <span className={statusClass}>{ledgerStatus}</span>
                      <span className="ledger-card-tag">{x.purchaseDate || "日期未填"}</span>
                    </div>
                    <h3 className="ledger-card-title">{x.brand || "品牌未填"} · {x.item || "商品名未填"}</h3>
                    <p className="ledger-card-subtitle">{x.id} / {x.category || "区分未填"} / {feature || "特征未填"}</p>
                    <div className="ledger-card-tags">
                      <span className="ledger-card-tag">{auction ? "日本拍卖" : (x.source || "来源未填")}</span>
                      <span className="ledger-card-tag">数量 {x.qty || 1}</span>
                      <span className="ledger-card-tag">{currency}</span>
                      {auction?.auctionCode && <span className="ledger-card-tag">落札 {auction.auctionCode}</span>}
                    </div>
                    <button className="ghost ledger-card-detail-toggle" onClick={() => toggleLedgerDetail(x.id)}>
                      {isDetailOpen ? "收起登记细节" : "展开登记细节"}
                    </button>
                  </div>
                  <div className="ledger-card-money">
                    <div className="ledger-money-cell"><span>实际支付</span><b>{actualPayment}</b></div>
                    <div className="ledger-money-cell"><span>库存成本</span><b>{inventoryCost}</b></div>
                    <div className="ledger-money-cell"><span>可抵扣税</span><b>{taxCredit}</b></div>
                    <div className="ledger-money-cell"><span>本人确认</span><b>{ledgerIdCheck(x) || "—"}</b></div>
                  </div>
                </div>
                {isDetailOpen && (
                  <div className="ledger-card-grid">
                    <div className="ledger-card-section">登记细节</div>
                    ...
                    <div className="ledger-card-label">备注</div><div className="ledger-card-value full">{displayMemo(x) || "—"}</div>
                    <div className="ledger-card-label">台账状态</div><div className="ledger-card-value"><span className={statusClass}>{ledgerStatus}</span></div>
                    <div className="ledger-card-label">更正履历</div><div className="ledger-card-value full">{latestHistoryText(x) || "—"}</div>
                  </div>
                )}
              </div>
...
function TaxReport({ items, totals, customsBatches, downloadCSV }) {
  ...
  const importRows = (customsBatches || []).map((b) => {
    const duty = Number(b.dutyJpy || 0);
    const batch = normalizeImportBatch(b);
    const importTax = Number(batch.totalImportConsumptionTaxJpy || 0);
    return [batch.id, batch.importDate || "", jpy(duty), jpy(importTax), b.memo || ""];
  });
  ...
  const auctionHammerTax = auctionItems.reduce((sum, x) => sum + Number(x.auction.hammerTax || 0), 0);
  const auctionFeeTax = auctionItems.reduce((sum, x) => sum + Number(x.auction.buyerFeeTax || 0), 0);
  const auctionInputTax = auctionItems.reduce((sum, x) => sum + Number(x.auction.taxCredit || Number(x.auction.hammerTax || 0) + Number(x.auction.buyerFeeTax || 0)), 0);
  const importConsumptionTax = (customsBatches || []).reduce((sum, b) => sum + Number(normalizeImportBatch(b).totalImportConsumptionTaxJpy || 0), 0);
  ...
  const taxAuditRows = [
    ...
    ...(customsBatches || []).flatMap((rawBatch) => {
      const batch = normalizeImportBatch(rawBatch);
      const rows = [];
      if (Number(batch.totalImportConsumptionTaxJpy || 0) > 0 && !batch.importDate) rows.push(["MEDIUM", batch.id || "未命名批次", "进口消费税", "有进口消费税但缺进口日期", "补录进口日期，便于期间归属"]);
      if (Number(batch.totalImportConsumptionTaxJpy || 0) > 0 && !batch.id) rows.push(["MEDIUM", "未命名批次", "进口消费税", "缺少Import Batch ID", "补录EMS或报关批次号"]);
      return rows;
    })
  ];
  ...
  const csv = [
    ...
    ...(customsBatches || []).map((raw) => { const b = normalizeImportBatch(raw); return ["进口消费税", b.id, "", "", b.importDate || "", "Import Batch", b.totalImportConsumptionTaxJpy ? "报关税单参考" : "未录入税额", [b.emsNo ? "EMS:" + b.emsNo : "", b.customsDeclarationNo ? "报关编号:" + b.customsDeclarationNo : "", raw.memo || ""].filter(Boolean).join(" / "), "", "", Math.round(Number(b.totalImportConsumptionTaxJpy || 0)), "", "", "", Math.round(Number(b.totalImportConsumptionTaxJpy || 0))]; }),
    ...soldItems.map((x) => {
      const sales = calcSalesBreakdown(x);
                  ...
                  <div key={item.id} style={{background:"#fff", border:"1px solid #e5e7eb", borderRadius:"14px", padding:"10px", boxShadow:"0 8px 18px rgba(15,23,42,.05)"}}>
                    ...
                    {editingPlatformId === item.id ? (
                      ...
                      <div className="action-row" style={{marginTop:"10px", flexWrap:"wrap"}}>
                        ...
                        {prevStatus && <button className="ghost" onClick={() => moveStatus(item, prevStatus)}>退回{prevStatus}</button>}
...
function buildAiBusinessStats(items, suppliers) {
  ...
  const todayProfit = todaySold.length === 0 ? 0 : todaySold.reduce((a, x) => a + calcTax(x).profitExTax, 0);
  const monthSale = monthSold.reduce((a, x) => a + calcTax(x).saleJpy, 0);
  const monthProfit = monthSold.length === 0 ? 0 : monthSold.reduce((a, x) => a + calcTax(x).profitExTax, 0);
  const now = new Date();
  function ageDays(x) {
    if (!x.purchaseDate) return 0;
    const d = new Date(x.purchaseDate);
