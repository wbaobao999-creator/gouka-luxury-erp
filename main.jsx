  ...
  function companyPdfHeader(title, subtitle = "Inventory Report") {
    ...
    return `
      ...
      <div class="report-title enterprise-title">
        ...
        <div class="erp-version">GOUKA ERP Enterprise 3.0</div>
      </div>
    `;
  }
...
<div class="pdf-page">${bodyHtml}</div>
  ...
  function exportInventoryPdf(targetItems = null, label = "库存报告") {
    ...
    const body = `
      ...
      <div class="footer">GOUKA ERP Enterprise 3.0 / Generated by GOUKA ERP. 金额与消费税为内部参考，正式申告请交由税理士确认。</div>
    `;
    ...
    <div className="app">
      <aside>
        <div className="brand">
          ...
          <div>
            <b>豪嘉株式会社</b>
            <span>GOUKA ERP Enterprise 3.0</span>
          </div>
        </div>
