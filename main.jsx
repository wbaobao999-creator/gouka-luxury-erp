...
<div class="pdf-page">${bodyHtml}</div>
  ...
  function exportItemPdf(item) {
    ...
    const body = `
      <div class="pdf-header">
        <div>
          <h1>商品资料 PDF</h1>
          <p>Product Sheet / GOUKA ERP Enterprise 1.0</p>
        </div>
        <div class="company">
          <b>豪嘉株式会社</b><br />
          GOUKA INC.<br />
  ...
  function exportInventoryPdf(targetItems = null, label = "库存报告") {
    ...
    const body = `
      ...
      <div class="footer">GOUKA ERP Enterprise 1.0 / Generated by GOUKA ERP. 金额与消费税为内部参考，正式申告请交由税理士确认。</div>
    `;
    ...
    <div className="app">
      <aside>
        <div className="brand">
          ...
          <div>
            <b>豪嘉株式会社</b>
            <span>GOUKA ERP Enterprise 1.0</span>
          </div>
        </div>
      ...
      <main>
        <header>
          <div>
            <h1>豪嘉ERP Enterprise 1.0 Production</h1>
  ...
  return (
    <section className="v3-dashboard">
      ...
      <div className="panel wide">
        <h2>经营提醒</h2>
        <p>V7.11新增今日经营、库存预警、品牌利润排行、供应商利润排行。Enterprise 1.0正式版：已统一商品图片显示，库存、古物、出品、销售、EMS、利润、消费税页面都可看图；删除会写入审计日志，本地仍保留自动备份。</p>
      </div>
    </section>
  );
}
