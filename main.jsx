...
const goukaWideTableFixStyle = document.createElement("style");
goukaWideTableFixStyle.textContent = "
.app{grid-template-columns:180px minmax(0,1fr)!important;}
aside{padding:10px 8px!important;}
aside button{padding:10px 8px!important;font-size:14px!important;}
main{max-width:none!important;width:100%!important;margin:0!important;padding:12px 14px 32px!important;}
main>header{margin-bottom:12px!important;padding:14px 16px!important;}
.panel{padding:14px!important;width:100%!important;}
.tablewrap{width:100%!important;max-width:100%!important;overflow-x:auto!important;}
table{width:100%!important;min-width:1180px!important;table-layout:auto!important;}
th,td{padding:8px 7px!important;font-size:12px!important;}
td:nth-child(7),td:nth-child(8),td:nth-child(9),th:nth-child(7),th:nth-child(8),th:nth-child(9){min-width:110px!important;}
td:nth-child(6),th:nth-child(6){min-width:170px!important;}
td:nth-child(2),th:nth-child(2){min-width:125px!important;}
.toolbar{gap:10px!important;}
.toolbar-right{flex-wrap:wrap!important;justify-content:flex-end!important;}
.search input{min-width:260px!important;}
.inventory-summary-grid{grid-template-columns:repeat(5,minmax(0,1fr))!important;}
.table-pager{position:sticky!important;left:0!important;right:0!important;background:#fff!important;z-index:2!important;padding:6px 0!important;}
@media(max-width:1200px){.app{grid-template-columns:160px minmax(0,1fr)!important;}main{padding:10px!important}.inventory-summary-grid{grid-template-columns:repeat(3,minmax(0,1fr))!important;}table{min-width:1100px!important;}}
";
document.head.appendChild(goukaWideTableFixStyle);
