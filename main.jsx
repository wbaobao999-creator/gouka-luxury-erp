...
<div class="pdf-page">${bodyHtml}</div>
  ...
  function exportItemPdf(item) {
    ...
    const body = `
      <div class="pdf-header">
        <div>
          <h1>商品资料 PDF</h1>
          <p>Product Sheet / GOUKA ERP Enterprise 1.2.4</p>
        </div>
        <div class="company">
          <b>豪嘉株式会社</b><br />
          GOUKA INC.<br />
  ...
  function exportInventoryPdf(targetItems = null, label = "库存报告") {
    ...
    const body = `
      ...
      <div class="footer">GOUKA ERP Enterprise 1.2.4 / Generated by GOUKA ERP. 金额与消费税为内部参考，正式申告请交由税理士确认。</div>
    `;
    ...
    <div className="app">
      <aside>
        <div className="brand">
          ...
          <div>
            <b>豪嘉株式会社</b>
            <span>GOUKA ERP Enterprise 1.2.4</span>
          </div>
        </div>
      ...
      <main>
        <header>
          <div>
            <h1>豪嘉ERP Enterprise 1.2.4 Listing Light</h1>
  ...
  return (
    <section className="v3-dashboard">
      <div className="v3-hero">
        <div>
          <span className="v3-kicker">GOUKA ERP Enterprise 1.2.4</span>
          <h1>经营驾驶舱 · Enterprise 1.2.4</h1>
      ...
      <div className="panel wide">
        <h2>经营提醒</h2>
        <p>V7.11新增今日经营、库存预警、品牌利润排行、供应商利润排行。Enterprise 1.2.4：优化出品管理优先级、统一图片尺寸、菜单按日常业务重新排序；保留云端同步、PDF、古物台账和全页面图片。</p>
      </div>
    </section>
  );
}
...
function ListingManagement({ items, updateListingItem, editItem, setPreviewImage, setPreviewScale }) {
  ...
  return (
    <div className="panel">
      ...
      <p className="note">Enterprise 1.2.4：出品管理轻量优化。每列默认显示30件，显示件数与总成本；卡片压缩；支持勾选后批量加入 NBAA / OBA / ECO 或批量改状态。</p>
